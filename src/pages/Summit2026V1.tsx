...
const Summit2026V1 = () => {
  ...
  const ticketSoon = () => {
    toast({
      ...
      description: (
        <>
          Sales will open to UXSG members first, then the public. Meanwhile, join the waitlist and check out our{" "}
          <Link
            to="/membership"
            className="font-medium underline underline-offset-2 text-foreground hover:text-foreground/90"
          >
            membership options
          </Link>
          .
  ...
  return (
    <main id="main" className="space-y-24 md:space-y-32 pb-20">
        ...
        <div className="flex flex-col items-center gap-10 lg:gap-12">
          <div className="space-y-8 text-center w-full max-w-3xl mx-auto pt-4 md:pt-6">
            ...
            <p className="font-body text-xl md:text-2xl text-foreground/90 max-w-2xl mx-auto leading-relaxed">
              2 half days. Real builds. <br />For future-forward designers navigating the AI shift.
            </p>
      ...
      <section className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12 lg:gap-16 items-start">
        <div className="md:col-span-1 lg:col-span-1 min-w-0">
          <h3 className="font-headline text-3xl lg:text-4xl text-uxsg-ink mb-4 md:mb-0 lg:ml-16">
            Laptops open, tools in hand.<br /><br />Leave with something you can actually use.
          </h3>
        </div>
      ...
      {/* Agenda */}
      <section id="agenda" className="max-w-7xl mx-auto px-6">
        <SketchySectionTitle
          className="mb-4"
     ...
     <section id="facilitators" className="max-w-7xl mx-auto px-6">
      ...
      {/* Pricing — full-bleed gradient; content stays max-w-4xl */}
      <section
        id="pricing"
      ...
      >
        ...
        <SketchySectionTitle 
        className="mb-12"
        badge={<SketchyBadge rotation="subtle">Sales Open Soon</SketchyBadge>}>
          Get Your Ticket</SketchySectionTitle>
        ...
        <div className="w-full mb-10 md:mb-12">
          <section className="w-full rounded-3xl border border-uxsg-ink/10 bg-muted/50 px-6 py-6 sm:px-7 sm:py-7 md:px-8 md:py-8 lg:px-9 lg:py-9">
            <p className="text-sm font-body text-uxsg-ink mb-2">
              Join the waitlist to be in the loop for early bird sales, speaker announcements, and agenda
              updates.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <div>
              ...
              <p className="font-body text-sm mb-8 opacity-80">Yeah, you read that right. Cheaper than your morning coffee.<br /> <br />Limited to the first 20 tickets.</p>
            </div>
            <SketchyRectButton
              type="button"
              variant="dark-bg"
          ...
          >
            <div>
              ...
              <p className="font-body text-sm mb-8 opacity-80">Standard access after early bird sales ends.<br /> <br />Ticket sales help us cover subscription costs and keep the event accessible.</p>
            </div>
            <SketchyRectButton
              type="button"
              variant="dark-bg"
