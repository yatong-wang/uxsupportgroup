...
const AgendaSection = () => {
  const sessions = [
    ...
    { time: "12:45 PM", title: "Lunch & Sponsor Demo", facilitator: "Danny Setiawan", desc: "45-min lunch break with a sponsor demo session featuring Kommodo AI—an AI-powered tool for stakeholder communication and collaboration" },
