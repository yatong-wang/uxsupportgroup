...
const SummitSponsorshipSection = () => {
  ...
  const standardFeatures = ["Give away up to 100 free credits to engaged UX professionals", "Sponsor logo on summit page", "Logo on credits/offer landing page", "Featured in post-event attendee emails"];
